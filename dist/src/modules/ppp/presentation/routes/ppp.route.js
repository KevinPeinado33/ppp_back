...
const { getEvaluationHistory, getResultSatisfaction, getDocumentsPPP, postCreateEvaluation, postCreateQuestionAnswer } = new controller_1.EvaluationController();
const { updateAssingAdvisor, postcompanyPPP, updateIntershipHours, updateRegisterLetterAceptance, updateClosePpp } = new controller_1.PPPController();
...
route.post('/create-evaluation', jwt_1.validateJWT, postCreateEvaluation);

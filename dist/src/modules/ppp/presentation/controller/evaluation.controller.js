...
class EvaluationController {
    ...
    postCreateEvaluation(req, res) {
        ...
        const usecase = new use_cases_1.CreateEvaluationUseCase(res, createEvaluationDto, this.evaluationRepository, this.PPPRepository, this.questionAnswerRepository);
        usecase.execute();
    }
    ...
    putTakeEvaluation(req, res) {
        const { idEvaluation } = req.params;
        const takeEvaluationDto = req.body;
        const usecase = new use_cases_1.TakeEvaluationUseCase(res, takeEvaluationDto, this.evaluationRepository, this.questionAnswerRepository, idEvaluation);
        usecase.execute();
    }
}

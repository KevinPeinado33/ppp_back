...
class StudentController {
    constructor() {
        ...
        this.userRepository = new repositories_2.UserImplRepository();
    ...
    postCreate(request, response) {
        ...
        const usecase = new use_cases_1.CreateStudentUseCase(response, this.studentRepository, this.userRepository, studentCreate);
        usecase.execute();
    }

...
const { getAllPlans, postCreatePlan, postCreateAreaPlan, postCreateQuestionEvaluation, postCreateDocument, getTypesDocuments, getBasesPPP, getAreaPlanByPlan } = new controllers_1.PlanController();

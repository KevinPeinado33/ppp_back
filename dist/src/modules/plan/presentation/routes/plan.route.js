...
const { getAllPlans, postCreatePlan, postCreateAreaPlan, postCreateQuestionEvaluation, postCreateDocument, getTypesDocuments, getBasesPPP } = new controllers_1.PlanController();
